...
export const CollectionRelations = relations(CollectionModel , ({one , many}) => {
    return {
        postCollections: many(PostCollectionModel)
    }
})

export const PostCollectionRelations = relations(PostCollectionModel , ({one , many}) => {
    return {
        post: one(PostModel , {
...
export const TagCollectionRelations = relations(PostTagModel , ({one , many}) => {
    return {
        post: one(PostModel , {
